...
def mount_knowledge_routes(app: FastAPI):
    ...
    from server.chat.knowledge_programmer_interview_chat import knowledge_programmer_interview_chat
    ...
    app.post("/chat/knowledge_programmer_interview_chat",
             tag=["Knowledge Programmer Interview Chat"],
             summary="程序员面试对话")(knowledge_programmer_interview_chat)
